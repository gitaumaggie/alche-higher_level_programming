#!/usr/bin/python3
"""Defines a Rectangle class with additional square functionality."""


class Rectangle:
    """Represent a rectangle with validated dimensions."""
    ...
    def __str__(self):
        """Return the rectangle represented with its print symbol."""
        if self.__width == 0 or self.__height == 0:
            return ""
    ...
    def __repr__(self):
        """Return a string representation that recreates the rectangle."""
